===================================
Release Notes Scarthgap 6.12 v2.2.1
===================================
...
.. note::
    ...
    Release v2.2.1 only support for NAND on SL2619. All other functionality is identical to :doc:`scarthgap_6.12_v2.2.0`.
...
Astra (v2.2.1) GA Release is a unified software development kit supporting the SL-Series of MPUs.
...
.. note::
    ...
    `<https://github.com/synaptics-astra/tee-optee_dev/tree/scarthgap_6.12_v2.2.1/ta/vpu>`__.
...
`<https://github.com/synaptics-astra/sdk/tree/scarthgap_6.12_v2.2.1>`__
...
+-------------------------------+--------------------------+--------------------------------------------------------------------+
| NAND Support                  | SL2619                   | Supports booting from NAND Flash.                                  |
+-------------------------------+--------------------------+--------------------------------------------------------------------+
...
+---------+----------+----------+---------+----------+----------+---------------------+--------+-------------------------------------------------------------------------------------+
|   N/A   |   N/A    |   N/A    |   N/A   |   N/A    |    Y     | Linux Kernel        | 37379  | HostAP in not available on NAND image.                                              |
+---------+----------+----------+---------+----------+----------+---------------------+--------+-------------------------------------------------------------------------------------+
|   N/A   |   N/A    |   N/A    |   N/A   |   N/A    |    Y     | WiFi                | 37379  | WiFi interface is not available on NAND image.                                      |
+---------+----------+----------+---------+----------+----------+---------------------+--------+-------------------------------------------------------------------------------------+
|   N/A   |   N/A    |   N/A    |   N/A   |   N/A    |    Y     | Bluetooth           | 37379  | bluetoothctl not working on NAND image.                                             |
+---------+----------+----------+---------+----------+----------+---------------------+--------+-------------------------------------------------------------------------------------+