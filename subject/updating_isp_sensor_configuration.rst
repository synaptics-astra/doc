...
|        |                                                                                          | (mode 0)        |                                                          |                                                    |
|        | `Waveshare IMX415 Camera Module                                                          |                 | Dewarp w/ dolphin-csi0-with-expander-dewarp-imx415.dtbo  |                                                    |
|        |  <https://www.waveshare.com/imx415-98-ir-cut-camera.htm>`__`                             | 1920x1080 30fps |                                                          |                                                    |
|        |                                                                                          | (mode 1)        |                                                          |                                                    |
|        |                                                                                          |                 |                                                          |                                                    |
|        |------------------------------------------------------------------------------------------+-----------------+----------------------------------------------------------+----------------------------------------------------+
