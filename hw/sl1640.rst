...
-  DRAM: 4GB system memory — 1pcs of 4GB LPDDR4x-3733, x32 devices
...
-  **USB boot:** Connect USB-C usb2.0 port to the host PC, then follow
   the procedure in the :ref:`hardware_manual_button_settings_sl1640` section.
...
.. _hardware_manual_button_settings_sl1640:
